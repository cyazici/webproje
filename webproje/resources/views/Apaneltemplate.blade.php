...
<div class="page-container">
    ...
    @include('inc.Apanelsidebarmenu')
    <!-- sidebar menu area end -->
    <!-- main content area start -->
    <div class="main-content">
        <!-- header area start -->
    @include('inc.Apanelheader')
        <!-- header area end -->
...
<!-- start chart js -->
<script src="{{asset('admin-temp')}}/https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.2/Chart.min.js"></script>
<!-- start highcharts js -->
...
<script src="{{asset('admin-temp')}}/assets/js/line-chart.js"></script>
<!-- all pie chart -->
<script src="{{asset('admin-temp')}}/assets/js/pie-chart.js"></script>
<!-- others plugins -->
